'''
This is the version of dual_mlp.py when it just works, 
a lot of code is still there for debugging purpose
The simplified version of the code is in dual_mlp.py
'''
